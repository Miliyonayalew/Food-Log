...
<div align="center">
  ...
  <img src="https://cdn.pixabay.com/photo/2016/10/12/13/17/white-male-1734423_960_720.jpg" alt="logo" width="140"  height="auto" />
  <br/>
...
# 📖 [Food Log <a name="about-project"></a>
...
- [Coming soo](https://budget-ok5v.onrender.com)
...
```sh
  git clone https://github.com/Miliyonayalew/Food-Log.git
  cd budget-app
```
...
Feel free to check the [issues page](https://github.com/Miliyonayalew/Food-Log/issues).
